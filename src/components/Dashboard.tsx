...
function Dashboard() {
  ...
  // Extended loading to show logo video for 3 seconds
  useEffect(() => {
  ...
  // Show video loading screen while checking authentication or during extended loading
          ...
          <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                {realTimeData ? (
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center p-6 bg-blue-50 rounded-lg transition-all duration-300 hover:bg-blue-100 hover:shadow-lg hover:scale-105 cursor-pointer">
                      <Activity className="w-12 h-12 text-blue-600 mx-auto mb-2 transition-transform duration-300 hover:scale-110" />
                    ...
                    <div className="text-center p-6 bg-green-50 rounded-lg transition-all duration-300 hover:bg-green-100 hover:shadow-lg hover:scale-105 cursor-pointer">
                      <TrendingUp className="w-12 h-12 text-green-600 mx-auto mb-2 transition-transform duration-300 hover:scale-110" />
                    ...
                    <div className="text-center p-6 bg-purple-50 rounded-lg transition-all duration-300 hover:bg-purple-100 hover:shadow-lg hover:scale-105 cursor-pointer">
                      <Clock className="w-12 h-12 text-purple-600 mx-auto mb-2 transition-transform duration-300 hover:scale-110" />
            ...
            {activeTab === 'seo' && (
              <div className="space-y-6">
                {seoMetrics ? (
                  <>
                    <div className="bg-white rounded-lg shadow p-6 transition-all duration-300 hover:shadow-xl hover:scale-105 cursor-pointer">
                      <h3 className="text-lg font-semibold mb-4">SEO Score</h3>
                      <div className="text-center">
                        <div className="inline-flex items-center justify-center w-32 h-32 rounded-full bg-gradient-to-r from-green-400 to-blue-500 text-white transition-transform duration-300 hover:scale-110">
                          <div className="text-center">
        ...
        {!selectedUrl && (
          <div className="text-center py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow transition-all duration-300 hover:shadow-xl hover:scale-105 cursor-pointer">
                <BarChart3 className="w-8 h-8 text-blue-600 mb-3 transition-transform duration-300 hover:scale-110" />
                <h3 className="font-semibold mb-2">Real-time Analytics</h3>
                <p className="text-sm text-gray-600">Monitor live traffic and user activity</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow transition-all duration-300 hover:shadow-xl hover:scale-105 cursor-pointer">
                <Globe className="w-8 h-8 text-green-600 mb-3 transition-transform duration-300 hover:scale-110" />
              ...
              <div className="bg-white p-6 rounded-lg shadow transition-all duration-300 hover:shadow-xl hover:scale-105 cursor-pointer">
                <TrendingUp className="w-8 h-8 text-purple-600 mb-3 transition-transform duration-300 hover:scale-110" />
